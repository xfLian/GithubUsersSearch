...
+ (AFHTTPSessionManager *) creatOneWayAuthenticationHttpsManager; {
    ...
    //[manager.requestSerializer setValue:GitHub_Token forHTTPHeaderField:@"access_token"];
    [manager.requestSerializer setValue:@"application/json;charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [manager.requestSerializer willChangeValueForKey:@"timeoutInterval"];
    manager.requestSerializer.timeoutInterval = 20.f;
    [manager.requestSerializer didChangeValueForKey:@"timeoutInterval"];
    
    [manager.requestSerializer setAuthorizationHeaderFieldWithUsername:@"xfLian"  password:@"lianxiaofei620"];
...
+ (AFSecurityPolicy *) getOneWayCustomHttpsPolicy:(AFHTTPSessionManager*)manager{
    ...
    NSString *cerPath  = [[NSBundle mainBundle] pathForResource:@"*.github.com" ofType:@"cer"];
...
+ (AFHTTPSessionManager *) creatTwoWayAuthenticationHttpsManager; {
    ...
    [manager.requestSerializer setValue:GitHub_Token forHTTPHeaderField:@"token"];
    [manager.requestSerializer setValue:@"application/json;charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [manager.requestSerializer willChangeValueForKey:@"timeoutInterval"];
    manager.requestSerializer.timeoutInterval = 20.f;
    [manager.requestSerializer didChangeValueForKey:@"timeoutInterval"];
